...
public:
	...
	TASKEXPORT int RunScheduledTaskNow(SCHEDENTRY *pse, long wdate, long wtime);

	typedef SCHEDULE::iterator stiterator;
	TASKEXPORT inline stiterator stbegin(){ return schedule.begin(); }
	TASKEXPORT inline stiterator stend(){ return schedule.end(); }
